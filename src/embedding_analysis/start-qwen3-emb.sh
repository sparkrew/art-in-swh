...
CUDA_VISIBLE_DEVICES=0 \
vllm serve ../links/projects/def-baudry/shared/huggingface/models--Qwen--Qwen3-Embedding-8B/snapshots/1d8ad4ca9b3dd8059ad90a75d4983776a23d44af \
  --host 0.0.0.0 \
  --port 8000 \
  --served-model-name qwen3-embdeggin-8b \
  --dtype auto \
  --max-model-len 8192 \
  --gpu-memory-utilization 0.9 \
